...
class Vehiclcertificates extends BaseController
{
    public $access;
    public $session;
    public $added_by;
    ...
    public function index()
    {
        if ($this->access === 'false') {
            ...
            $this->VCModel->join('party', 'party.id = vehiclewise_certificates.party_id');
    ...
    public function create()
    {
        ...
        if ($this->access === 'false') {
            ...
            return $this->response->redirect(base_url('vehicle-certificates'));
        } else {
            $this->view['party'] = $this->PModel->where('status', '1')->findAll();
            $this->view['vehicles'] = $this->VModel->findAll();
            $this->view['cert_type'] = $this->DTModel->findAll();
