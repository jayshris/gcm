                  ...
                  <div class="card-body">
                    <div class="settings-form">
                      ...
                      <div class="settings-sub-header">
                        <h6><?= isset($tyre_details) ? 'Edit' : 'Add' ?> Tyre Model</h6>
                      </div>
                      <div class="profile-details">
                        <div class="row g-3">

                          <div class="col-md-6">
                            <label class="col-form-label">Model Name <span class="text-danger">*</span></label>
                            <input type="text" required name="model" value="<?= isset($tyre_details) ?  $tyre_details['model'] : set_value('model') ?>" class="form-control">
                          </div>
