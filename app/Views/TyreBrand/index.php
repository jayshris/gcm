                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-12 page-header mb-0">
                        <div class="row align-items-center">
                          <div class="col-8">
                            <h4 class="page-title">Tyre Brands</h4>
                          </div>
                          <div class="col-4 text-end">
                            <div class="head-icons">
                              <a href="<?= base_url('tyrebrand') ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
