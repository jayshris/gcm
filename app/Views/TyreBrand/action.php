                  ...
                  <div class="card-body">
                    <div class="settings-form">
                      ...
                      <div class="settings-sub-header">
                        <h6><?= isset($tyre_details) ? 'Edit' : 'Add' ?> Tyre Brand</h6>
                      </div>
                      <div class="profile-details">
                        <div class="row g-3">
                          ...
                          <div class="col-md-6">
                            ...
                            <input type="text" required name="brand_name" value="<?= isset($tyre_details) ?  $tyre_details['brand'] : set_value('brand_name') ?>" class="form-control">
                          </div>
