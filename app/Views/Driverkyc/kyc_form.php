        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 mt-3">
                    ...
                    <!-- Settings Info -->
                    <form method="post" action="<?php echo base_url('driverkyc/register/' . $token) ?>" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-wrap">
                                            ...
                                            <select class="dropdown select2" name="foreman_id" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-wrap">
                                            ...
                                            <input type="text" required name="driver_name" class="form-control" value="<?= set_value('driver_name') ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-wrap">
                                            ...
                                            <select class="dropdown form-control" name="vehicle_types[]" required>
        ...
        jQuery(document).ready(function($) {
            ...
            $("#dl_no").on('change', function() {
                ...
                if (dl_no) {
                    $.ajax({
                        type: 'POST',
                        url: '<?= base_url('driverkyc/validate_dl') ?> ',
                        data: {
                            dl_no: dl_no
                        },
                        success: function(response) {
