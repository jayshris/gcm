            ...
            <div class="card main-card">
              <div class="card-body">
                ...
                <div class="mb-3">
                  <div class="row">
                    <div class="col-md-12">
                      <a href="<?php echo base_url(); ?>kyc/generate_link" class="btn btn-info" role="button">Generate KYC Link</a>
                    </div>
                  </div>
                </div>
                    ...
                    <tbody>
                      ...
                      if ($party_data) {
                        foreach ($party_data as $party) {
                          ...
                          echo '
                                <tr>
                                    <td><a href="kyc/approve/' . $party['id'] . '" class="btn btn-info btn-sm" role="button">Approve <i class="fa fa-check" aria-hidden="true"></i></a></td>                                    
