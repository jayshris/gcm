                        ...
                        <div class="profile-details">
                          <div class="row g-3"> 
                            ...
                            <div class="col-md-3">
                              ...
                              <select class="form-select select2" required name="booking_for" id="booking_for" aria-label="Default select example" disabled>
                            ...
                            <div class="col-md-3">
                              ...
                              <select class="form-select select2" name="vehicle_rc" id="vehicle_rc"  disabled aria-label="Default select example">
                            ...
                            <div class="col-md-4">
                              ...
                              <select class="form-select select2" required name="customer_id" disabled id="customer_id" aria-label="Default select example" onchange="$.getPartyType();">
                            ...
                            <div class="col-md-3">
                              ...
                              <select class="form-select" name="customer_branch" disabled required id="customer_branch" aria-label="Default select example">
                            ...
                            <div class="col-md-3">
                              ...
                              <select class="form-select" name="customer_type" id="customer_type" disabled aria-label="Default select example">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" name="pickup_state_id" disabled aria-label="Default select example" required onchange="getCitiesByState(this.value,'pickup_city')">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" name="pickup_city" disabled id="pickup_city" aria-label="Default select example" required  onchange="changeCity(this,$(this).find(':selected').attr('pickup_city_id'),'pickup_city_id')">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="pickup_pin" class="form-control"  disabled value="<?= isset($booking_pickups['pincode']) ? $booking_pickups['pincode'] : '' ?>">
                            ...
                            <div class="col-md-3">
                                <label class="col-form-label">State<span class="text-danger">*</span></label>
                                <select class="form-select" name="drop_state_id" disabled aria-label="Default select example" required  onchange="getCitiesByState(this.value,'drop_city')">
                                        <option value="">Select State</option>
                                        <?php foreach ($states as $s) { ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" name="drop_city" disabled id="drop_city" aria-label="Default select example" required  onchange="changeCity(this,$(this).find(':selected').attr('drop_city_id'),'drop_city_id')">
                                        <option value="">Select </option> 
                            ...
                            <div class="col-md-3">
                                <label class="col-form-label">PinCode</label>
                                <input type="text" name="drop_pin" class="form-control" disabled value="<?= isset($booking_drops['pincode']) ? $booking_drops['pincode'] : '' ?>">
                            ...
                            <div class="col-md-2">
                              ...
                              <input type="date" required name="pickup_date" disabled id="pickup_date" value="<?= $booking_details['pickup_date'] ?>" class="form-control">
                            </div>

                            <div class="col-md-2">
                              <label class="col-form-label">Drop Date</label>
                              <input type="date" name="drop_date" id="drop_date" disabled value="<?= $booking_details['drop_date'] ?>" class="form-control">
                            </div>
                            ...
                            <div class="col-md-2">
                              ...
                              <input type="date" required name="booking_date" disabled value="<?= $booking_details['booking_date'] ?>" class="form-control">
                            </div>
                            ...
                            <div class="col-md-3">
                              ...
                              <input type="number" name="guranteed_wt" readonly id="guranteed_wt" onchange="$.calculation()" class="form-control" value="<?= $booking_details['guranteed_wt'] ?>">
                            </div>

                            <div class="col-md-2">
                              <label class="col-form-label">Total Freight</label>
                              <input type="number" name="freight" readonly id="freight" onchange="$.calculation()" class="form-control" value="<?= $booking_details['freight'] ?>" readonly>
                            </div>

                            <div class="col-md-2">
                              <label class="col-form-label">Advance</label>
                              <input type="number" name="advance" readonly id="advance" onchange="$.calculation()" class="form-control" value="<?= $booking_details['advance'] ?>">
                            </div>

                            <div class="col-md-2">
                              <label class="col-form-label">Discount</label>
                              <input type="number" name="discount" readonly id="discount" onchange="$.calculation()" class="form-control" value="<?= $booking_details['discount'] ?>" readonly>
                            </div>

                            <div class="col-md-2">
                              <label class="col-form-label">Balance</label>
                              <input type="number" name="balance" readonly id="balance" onchange="$.calculation()" class="form-control" value="<?= $booking_details['balance'] ?>" readonly>
                            </div>

                            <div class="col-md-3">
                              <label class="col-form-label">Bill To<span class="text-danger">*</span></label>
                              <select class="form-select select2" disabled required name="bill_to" aria-label="Default select example" onchange="">
