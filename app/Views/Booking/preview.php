                  ...
                  <div class="card-body">
                    <div class="settings-form">                      
                      <form method="post" enctype="multipart/form-data" action="<?php echo base_url('booking/approve/' . $booking_details['id']); ?>">
                        <div class="settings-sub-header noprint">
                          <h6>Booking</h6>
                        </div>
                        <div class="profile-details">
                          <div class="row g-3">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <label class="col-form-label"><b>Customer Branch: </b></label>
                                <label class="col-form-label"><?= isset($booking_details['office_name']) && !empty($booking_details['office_name']) ? $booking_details['office_name'] : '-' ?></label>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-3">
                                <label class="col-form-label"><b>Pickup Date: </b> </label>
                            ...
                            <div class="col-md-3 col-sm-3">
                                <label class="col-form-label"><b>Drop Date: </b> </label>
                            ...
                            <div class="col-md-6 col-sm-6">
                              ...
                              <label class="col-form-label"><?= isset($booking_details['guranteed_wt']) && !empty($booking_details['guranteed_wt']) ? $booking_details['guranteed_wt'] : '-' ?></label> 
                            </div>
                            ...
                            <div class="col-md-6 col-sm-6">
                              ...
                              <label class="col-form-label"><?= isset($booking_details['advance']) && !empty($booking_details['advance']) ? $booking_details['advance'] : '-' ?></label> 
                            </div>

                            <div class="col-md-6 col-sm-6">
                              <label class="col-form-label"><b>Discount: </b></label>
                              <label class="col-form-label"><?= isset($booking_details['discount']) && !empty($booking_details['discount']) ? $booking_details['discount'] : '-' ?></label> 
                            </div>
                                ...
                                <tbody>
                                  ...
                                  ?>
                                    <tr id="del_expense_<?= $i ?>">
                                      <td> 
                                      <?= isset($be['head_name']) && !empty($be['head_name']) ? $be['head_name'] : '-' ?>
                                      </td>  
                                      <td> 
                                  ...
                                  <?php
                                    ...
                                    <tr>
                                      <td colspan="2">Expense not found</td>
                                    </tr>
                                    <?php } ?>
