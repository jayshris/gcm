...
<div class="col-md-3">
    ...
    <input type="text" readonly   class="form-control" value="<?= isset($booking['proforma_invoices_no']) && ($booking['proforma_invoices_no']) ? $booking['proforma_invoices_no'] : '' ?>"/>
</div>	

<div class="col-md-2">
    <label class="col-form-label">Vehicle No.</label>
    <input type="text" readonly   class="form-control" value="<?= isset($booking['rc_number']) && ($booking['rc_number']) ? $booking['rc_number'] : '' ?>"/>
</div>	
