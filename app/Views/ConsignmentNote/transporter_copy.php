<table cellspacing="0" class="print-table">
    <tbody> 
        ...
        <tr style="height:21pt">
            <td class="s6td" colspan="6">
                <p class="s6 p13">
                    ...
                    <span class="s7 prtds10">Transporter Copy</span>
                </p>
            </td>
        </tr>
        <tr style="height:21pt">
        ...
        <tr style="height:11pt">
            ...
            <td  class="td37" >
                <p class="s9 p11">Actual Weight</p>
            </td>
            <td  class="td38" >
        ...
        <tr style="height:21pt">
            ...
            <td class="td42" >
                <p class="s10 p11" ><?= isset($lr['no_of_packages']) && ($lr['no_of_packages']>0) ? number_format($lr['no_of_packages'],2) : '-' ?></p>
            </td>
            <td class="td43" >
                <p class="s10 p11" ><?= isset($lr['actual_weight']) && ($lr['actual_weight']>0) ? number_format($lr['actual_weight'],2).' KG' : ' 0 KG' ?></p>
            </td>
            <td class="td44" >
                <p class="s10 p11" ><?= isset($lr['charge_weight']) && ($lr['charge_weight']>0) ? number_format($lr['charge_weight'],2).' KG' : ' 0 KG' ?></p>
            </td>
            <td class="td45" >
                <p class="s10 p11" ><?= isset($lr['payment_terms']) && (!empty($lr['payment_terms'])) ? strtoupper($lr['payment_terms']) : ' 0 KG' ?></p>
            </td>
        </tr>
        <tr style="height:11pt">
            <td class="td46" colspan="2">
                <p class="s9 p11">EWAYBill Number</p>
            </td>
            <td class="td47" colspan="2">
                <p class="s9 p11">EWAYBillExpiryDate</p>
            </td>
            <td class="td48" colspan="2">
                <p class="s9 p11">FreightChargesAmount</p>
            </td>
        </tr>
        <tr style="height:13pt">
            ...
            <td class="td51" colspan="2">
                <p class="s11 p11" ><?= isset($lr['freight_charges_amount']) && ($lr['freight_charges_amount']>0) ? 'Rs. '.number_format($lr['freight_charges_amount'],2) : 'Rs. 0' ?></p>
            </td>
        </tr>
        <tr style="height:11pt">
