					...
					<div class="col-md-12"> 
						...
						<div class="page-header">
							<div class="row align-items-center">
								<div class="col-8">
								<h4 class="page-title">Purpose Of Update</h4>
								</div>
										...
										<div class="col-md-3">
											<div class="form-wrap">
												...
												<select class="form-select" name="name" aria-label="Default select example">
													...
													<?php if(!empty($names)){
														foreach($names as $resaon){?>
														<option value="<?= $resaon['id'] ?>" <?= set_value('name') == $resaon['id'] ? 'selected' : '' ?>><?= ucfirst($resaon['name']) ?></option>
														<?php }}?>
												</select>
											</div>
										</div>
