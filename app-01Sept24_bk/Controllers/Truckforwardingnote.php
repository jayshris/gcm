...
class Truckforwardingnote extends BaseController
{
    ...
    {        
     ...
     $this->LoadingReceiptModel->select('loading_receipts.*,b.booking_number,o.name branch_name')
      ...
      return view('TruckForwardingNote/index', $this->view); 
    } 
  
    function preview($id){  
      $this->view['lr'] = $this->LoadingReceiptModel
      ->select('loading_receipts.*,b.booking_number,b.rate,o.name branch_name,v.rc_number,s.state_name consignor_state,s2.state_name consignee_state,
      ...
      return view('TruckForwardingNote/preview', $this->view); 
    }
}
