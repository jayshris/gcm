                ...
                <div class="card">
                  <div class="card-body">
                    <div class="settings-form">
                      ...
                      <form method="post" enctype="multipart/form-data" action="<?= base_url('customers/edit/' . $customer_detail['id']) ?>">
                        ...
                        <div class="profile-details">
                          <div class="row g-3">
                            ...
                            <div class="col-md-6" style="pointer-events:none;">
                              <label class="col-form-label">Party<span class="text-danger">*</span> <span class="text-danger msg"></span></label>
